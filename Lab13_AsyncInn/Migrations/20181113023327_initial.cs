    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "111 Alki Way", "Async Seattle", "998-853-5544" },
                    { 2, "123 Main St.", "Async Bellevue", "887-700-4030" },
                    { 3, "2244 Talbot Rd.", "Async Portland", "858-535-5221" },
                    { 4, "3003 Ocean Dr.", "Async Vancouver", "550-053-4477" },
                    { 5, "688 Blanshard St.", "Async Victoria", "423-111-5356" }
                });
